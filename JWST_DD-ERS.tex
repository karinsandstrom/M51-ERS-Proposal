...
\begin{itemize}
    ...
    %\item{Constrain the effect of the AGN on PAHs}\vspace{-0.1in}
...
\noindent {\bf Cluster Science -- DAD has worked on this}
...
\noindent {\bf AGN Diagnostics -- DAD has worked on this}
